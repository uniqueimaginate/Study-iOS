...
//  Firebase101
//
//  Created by Peter on 2021/11/11.
//
...
class ViewController: UIViewController {
    ...
    let db = Database.database(url: "https://fir-101-91535-default-rtdb.asia-southeast1.firebasedatabase.app/").reference()
...
extension ViewController {
    func saveBasicTypes() {
        ...
        db.child("array").setValue(["id": "anyId", "age": 10, "city":"seoul"])
    }
